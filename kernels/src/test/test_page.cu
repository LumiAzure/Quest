...
void _TestAppendPagedKVPrefillKernelCorrectness(size_t page_size,
	...
	std::cout << "Testing AppendPagedKVPrefillKernel with kv_layout="
			  << QKVLayoutToString(kv_layout) << ", page_size=" << page_size
			  << ", seq_len=" << seq_len << ", batch_size=" << batch_size
			  << ", num_heads=" << num_heads << ", head_dim=" << head_dim << std::endl;

	std::cout << "Initializing paged_kv_t on CPU..." << std::endl;
	...
	std::cout << "Initializing candidate_kv_t on CPU..." << std::endl;
	...
	std::cout << "Calculating candidate chunk data on CPU..." << std::endl;
	...
	std::cout << "Checkpoint 5 passed." << std::endl;
	utils::vec_fill_(candidate_min, CUDART_MAX_NORMAL_FP16);
	std::cout << "Checkpoint 6 passed." << std::endl;

	std::cout << "Reducing candidate chunk data on CPU..." << std::endl;
	...
	std::cout << "Preparing candidate_kv_t on CPU..." << std::endl;
	...
	std::cout << "Launching AppendPagedKVPrefill kernel on GPU..." << std::endl;
	...
	std::cout << "Initializing candidate_kv_t on GPU..." << std::endl;
